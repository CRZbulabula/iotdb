...
public class LogStoreLeaderBalancerTest {

  private static final LogStoreLeaderBalancer BALANCER = new LogStoreLeaderBalancer();
  ...
  public void bigClusterTest() {
    ...
    // Max leader num does not exceed max capacity
    Assert.assertTrue(maxLeaderNum <= BALANCER.getMaxCapacity());
    System.out.println(
        "Min Leader Num: "
            + minLeaderNum
            + ", Max Leader Num: "
